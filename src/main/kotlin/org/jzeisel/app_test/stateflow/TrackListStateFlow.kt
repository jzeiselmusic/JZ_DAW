...
data class TrackListState(
    ...
    val recordButtonOffset: Double = addButtonOffset + separationDistance - widgetSize/2.0,
    val inputButtonsOffset: Double = recordButtonOffset + separationDistance - widgetSize/2.0,
    val soloButtonOffset: Double = inputButtonsOffset + separationDistance - widgetSize/2.0,
    val muteButtonOffset: Double = inputButtonsOffset + separationDistance - widgetSize/2.0,
